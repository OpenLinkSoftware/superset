...
class VirtuosoEngineSpec(BaseEngineSpec):
    """Engine for Virtuoso"""

    engine = "virtuoso"
    engine_name = "Virtuoso"

    sqlalchemy_uri_placeholder = (
        "virtuoso+pyodbc://user:password@dsn"
    )

    # Virtuoso uses FIRST to limit: `SELECT FIRST 10 * FROM table`
    ...
    def epoch_to_dttm(cls) -> str:
        return "DATEADD('second', {col}, stringdate('1970-01-01'))"
